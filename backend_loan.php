...
<div class="container" style="padding:0px; max-width: 1384px; ">
...
<h4 class="modal-title title_edit" id="myModalLabel">ANALYSE LOAN FILE</h4>&nbsp;  
    
     <div id='Loan_application_situations' class="btn-group">
         <button id="uni_key" class="button button-rounded button-small  button-purple btn-block nomargin" data-toggle="modal"><span class="text">Download PDF</span> </button> &nbsp;  
         ...
         <button id="uni_validate_loan" class="button button-rounded button-reveal button-small button-aqua btn-block nomargin" data-toggle="modal">
...
-->
         &nbsp; 
        <button id="uni_reject_loan" class="button button-rounded button-reveal button-small button-red btn-block nomargin"><i class="icon-trash2"></i><span>REJECT</span></button>
    </div> 
...
<textarea id="comment" name="comment" class="form-control not-dark" ></textarea>
</div>
...
<button class="button button-3d btn-success nomargin"  type="submit" id="vaidate" name="validate" onclick=" delval_process(); " value="validate">Validate</button>
    ...
    <div id="export_hidden" style="display:none;"> </div>
