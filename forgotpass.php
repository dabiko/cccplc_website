...
require_once('resources/auth_forgotpass.php');
auth_cuscheck_login();

if (isset($_GET['auth_code'])){
     $auth_code = $_GET['auth_code'];
if (auth_codecheck($auth_code)==true){
$_SESSION['header']=1;
...
<h5>HOWDY! <?php echo  $_SESSION['forgot_username']; ?></h5>
<p id='msg'> To Reset Your Password - Enter New Password and Confirm</p>
...
<button class="button button-3d button-primary nomargin"  type="button" id="submitButton"  onclick="reset_forgot(0,3)"><span id="btntext"> RESET </span><span id="msgSubmit"></span> </button>
</div>
</form>
</div>
</div>
...
<?php
       ...
       echo "<hr><br><br> <i style='color:red;'>ERROR CODE 2 FAILED : TO RETRIEVE CUSTOMER INFORMATION  <br> <a href='index.php'> BACK TO HOME </a></i>";
    }
}
else{
echo "<b style='color:red;'>SORRY AUTHENTICATION CODE IS NOT SET LINK MISSING PARAMETERS </b>";
}
?>