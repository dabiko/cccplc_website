                    ...
                    <div class="modal-body">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title title_edit" id="myModalLabel">CHECK
                                    ACCOUNT</h4>&nbsp;

                                <div id='account_opening_situations' class="btn-group">
                                    <button id="uni_key_accounts" class="button button-rounded button-small  button-purple btn-block nomargin" data-toggle="modal"><span class="text">Download PDF</span> </button> &nbsp;
                                    <button id="uni_key2" class="button button-rounded button-small button-amber btn-block nomargin naming_doc" data-toggle="modal">
                                        <span class="text">Download EXCEL</span>
                                    </button> &nbsp;
                                    <button id="uni_validate_acc" class="button button-rounded button-reveal button-small button-aqua btn-block nomargin" data-toggle="modal">
                                        <i class="icon-check"></i><span class="text">VALIDATE</span>
                                    </button> &nbsp;
                                    <!--
          <button id="uni_reject" class="button button-3d button-small btn-block nomargin" data-toggle="modal"><span class="text">REJECT</span>       
         </button>  
-->
                                    &nbsp;
                                    <button id="uni_reject_acc" class="button button-rounded button-reveal button-small button-red btn-block nomargin"><i class="icon-trash2"></i><span>REJECT</span></button>
                                </div>
            ...
            <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-body">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel">ENTER MOTIF</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            </div>
                            <div class="modal-body">

                                <div class="col_full">
                                    <label for="login-form-username">Enter Motif:</label>
                                    <textarea id="comment" name="comment" value="" class="form-control not-dark"></textarea>
                                </div>
                                <div class="col_full nobottommargin">
                                    <button class="button button-3d btn-success nomargin" type="submit" id="vaidate" name="validate" onclick=" delval_process(); " value="validate">Validate</button>
                                </div>
            ...
            <div id="export_hidden" style=" " hidden> </div>
...
<script>
    ...
    report_header.SUBTITLE = "***ACCOUNT OPENING FILE FOR";
    report_header.TITLE = 'CCC PLC ONLINE';
