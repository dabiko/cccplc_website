...
<div class="section nopadding nomargin" style="width: 100%; height: 100%; position: absolute; left: 0; top: 0; background: url('images/extra/loans.jpg') center center no-repeat; background-size: cover;"></div>
...
<form name="login-form"  id="loginForm" onsubmit="logincustomerForm(); return false;" method="POST" class="nobottommargin" action="#" >
...
<button class="button button-3d button-black nomargin"  type="submit" id="loginBtn" name="loginBtn"  value="login">Login<i style="display:none;" id="msgSubmit" class="fa fa-spinner fa-spin"></i></button><br><br>
   <span style="margin-bottom: 5px;"> <a href='reset.php'> forgot password ? </a></span>
    </div>
   </form>
