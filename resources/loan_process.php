...
$field_check= ["Other_Income_Sources", "Other_Sources_Details","Source_Of_Funds", "Marital_Type", "Spouse_Name", "Spouse_Profession", "Spouse_mobile_phone", "Spouse_email_address", "Children_Number", "children_mobile_phone", "Association_Name", "Association_Venue", "Association_President", "President_Contact", "Loan_security", "Principal_Payment_Means", "Other_Payment_Means", "Secondary_Payment_Means", "Current_Employer", "Employment_Date", "Matricule", "Employer_Mobile_Phone", "Employer_Email_Address", "Employer_Street", "Employer_Town", "Employer_Region", "Utility_Bills", "Social_Contributions", "Donations", "Health", "Other_Expenses", "Account_Other_Banks", "Name_Of_Banks", "Engagement_Other_Banks", "Engagement_Amounts"];
...
foreach($dataJson as $key => $value) 
{
   ...
   $member =$key;   
    ...
    $pos = array_search(sorted($member), array_map("sorted", $field_check), true);
...
try{
  ...
  if($output===true){
     $errorMSG= "LOAN CREATED SUCCESSFULLY";
...
//       throw new Exception($output);
        ...
        $errorMSG=  "LOAN REQUEST Error: ".$output;
